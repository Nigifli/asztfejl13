...
public class BillService(AppDbContext dbContext) : IMotorcycleService
{
    ...
    public async Task<ErrorOr<BillModel>> GetByIdAsync(string motorcycleId)
    {
        ...
        return new BillModel(motorcycle);
    }
